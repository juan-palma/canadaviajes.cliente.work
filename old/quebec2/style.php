...
.reservaW h3.red:after {
    content: "";
    background-image: url(img/imagenes/mancha_negra_titulos.png);
    width: 220px;
    height: 120px;
    position: absolute;
    left: 0;
...
#noesp .centerCol:after {
    ...
    left: 0;
    bottom: -200px;
    background-image: url(img/imagenes/doodle_quebec.svg);
    width: 100%;
    height: 500px;
